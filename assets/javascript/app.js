$(document).ready(function() {
  ...
  var questions = [
    ...
    },
    {
      ...
      choices: ["1,290", "1,949", "1,000", "5,083", "6,789"],
      answer: 1
    }
  ];
  ...
  function displayQuestion() {
    ...
    $("#firstQuestText").html("<h2>" + questions[index].question + "<h2>");
    dislpayAnswer();
  }
     
  
    function dislpayAnswer() {
    for (var i = 0; i < questions[index].choices.length; i++) {
      var idNumber = i + 1;
      $("#answer" + idNumber).text(questions[index].choices[i]);
    }
  }
